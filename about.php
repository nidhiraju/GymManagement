...
<body>
  <section id="container">
    ...
    <!-- **********************************************************************************************************************************************************
        ...
        *********************************************************************************************************************************************************** -->
    <!--main content start-->
   <div style="background-image: url('img/cool.jpg'); height: 100vh; background-repeat: no-repeat; background-size: cover;">
        <section id="main-content">
          <section class="wrapper">

            <h1 style="font-size: 50px; text-align: center; color: white "></i>THE ENERGY HUB</h1>
            <h2 style="font-size: 30px; text-align: center; color: white">Begin today, Win tommorow!</h2>
  
          </section>
          <section class="wrapper">
            
           <h2 style="font-size: 20px; color: black; font-weight: 1000; color: white;">WHAT DO WE DO?</h2>
           <p style="font-size: 20px; color: black; font-weight: 400; color: white;">The "Energy Hub Gym" has been the authority in Fitness since 2010, in Gokulam, Mysore.<br> It is a place for serious fitness!<br>Today, "The Energy Hub" Gym Has Expanded Its Fitness Profile To Offer All Of The Latest Equipment And Services, Including Group Exercise, Personal Training, Cardiovascular Equipment, Spinning, While Maintaining Its Core Weight Lifting Tradition. Most Importantly, Gold's Gym Continues To Change Lives By Helping People Achieve Their Individual Potential.</p>

           <h2 style="font-size: 20px; color: white; font-weight: 1000;">GYM INFO:</h2>
           <p style="font-size: 15px; color: white; font-weight: 400;">ADDRESS :  KD ROAD, GOKULAM, MYSORE, KARNATAKA</p>
           <p style="font-size: 15px; color: white; font-weight: 400;">CONTACT NO : 7349727005</p>
